...
angular.module('desktopApp')
  .controller('CustomersListCtrl', ['$http','$scope','$state','$modal','modalService','Customer','customerDataFactory',function ($http,$scope,$state,$modal,modalService,Customer,customerDataFactory){
