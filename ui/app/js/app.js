...
function ($stateProvider, $locationProvider, $urlRouterProvider, helper) {
  ...
  $stateProvider
    ...
    .state('app.customers', {
        ...
        templateUrl: helper.basepath('customers/customers.html')
    })
    ...
    .state('app.newcustomer',{
        url:'/newcustomer',
        title:'New Customer',
        templateUrl: helper.basepath('customers/newCustomer.html'),
        controller:'NewCustomerCtrl',
        resolve:helper.resolveFor('ui.select','ui-notification','angularFileUpload','filestyle')
    })
    .state('app.employees',{
        url:"/employees",
        title:'Employees',        
        controller:'EmployeesCtrl',
        templateUrl: helper.basepath('employees/employees.html')
    })
    .state('app.employees.list',{
        url: '/employeeslist',
        title:'Employees list',
        controller:'EmployeesListCtrl',
        templateUrl: helper.basepath('employees/employeesList.html')
    })
    .state('app.employees.details',{
        url: '/employeedetails/:id',
        title:'Employee details',
        controller:'EmployeesDetailsCtrl',
        templateUrl: helper.basepath('employees/employeesDetails.html')        
    })
    .state('app.newEmployee', {
        url:'/newemployee',
        title:'New Employee',
        templateUrl: helper.basepath('employees/newEmployee.html'),
    ...
    .state('app.appointments',{
        url:"/appointments",
        title:'Appointments',
        templateUrl: helper.basepath('appointments/appointments.html'),
        controller:'AppointmentsCtrl'
    })  
    .state('app.appointments.list',{
        url:'/appontmentslist',
        title:'Appointments list',
        templateUrl: helper.basepath('appointments/appointmentsList.html'),
        controller:'AppointmentsListCtrl'
    })
    .state('app.appointments.details',{
        url:'/appointmentdetails/:id',
        title:'Appointment details',
        templateUrl: helper.basepath('appointments/appointmentsDetails.html'),
        controller:'AppointmentsDetailsCtrl'
    }) 
    .state('app.services',{
        url:'/services',
        title:'Services',
        templateUrl: helper.basepath('services/services.html'),
        controller:'ServicesCtrl'
    })
    .state('app.services.list',{
        url:'/serviceslist',
        title:'Services list',
        templateUrl: helper.basepath('services/serviceslist.html'),
        controller:'ServicesListCtrl'
    })
    .state('app.services.details',{
    ...
    .state('app.newService',{
        url:"/newservice",
        title:'New Service',
        templateUrl: helper.basepath('services/newService.html'),
        controller:'NewServiceCtrl',
        resolve: helper.resolveFor('ui.select','ui-notification','angularFileUpload','filestyle')
    })
    .state('app.employeesSchedule',{
        url:'/employeesSchedule',
        title:'Employee Schedule',
        templateUrl: helper.basepath('employeesSchedule/employeesSchedule.html'),
        controller:'EmployeesScheduleCtrl'
    })
    .state('app.employeesSchedule.list',{
        url:'/employeesScheduleList',
        title:'Employees list',
        templateUrl: helper.basepath('employeesSchedule/employeesschedulelist.html'),
        controller:'EmployeesScheduleListCtrl'
    })
    .state('app.employeesSchedule.details',{
        url:'/employeesScheduleDetails/:id',
        title:'Employee Schedule details',
        templateUrl: helper.basepath('employeesSchedule/employeesScheduleDetails.html'),
        controller:'EmployeesScheduleDetailsCtrl'
    })
    .state('app.populateEmployeeSchedules',{
      url:'/populateEmployeeSchedules',
      title:'Populate employee schedule',
      templateUrl: helper.basepath('employeesSchedule/populateEmployeeSchedules.html'),
      controller:'PopulateEmployeeSchedulesCtrl'
    })
    .state('app.employeesManagement',{
      url:'/employeesManagement',
      title:'Employees management',
      templateUrl: helper.basepath('employeesManagement/employeesManagement.html'),
    ...
    .state('app.reports.list',{
      url:'/reportsList',
      title:'Reports list',
      templateUrl: helper.basepath('reports/reportsList.html'),
...
var myApp = angular.module('myAppName', ['desktopApp']);
