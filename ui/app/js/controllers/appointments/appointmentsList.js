...
App.controller('AppointmentsListCtrl', ['$scope','$state','$http', 'appointmentDataFactory',function ($scope,$state,$http,appointmentDataFactory) {
    
    $scope.$on('$stateChangeSuccess',function(){
     	if ($state.is('app.appointments.list'))
        	getAppointments();
    	});
    ...
    $scope.updateAppointment=function(id) {
      ...
      $state.go('app.appointments.details',{id:id})
    };
