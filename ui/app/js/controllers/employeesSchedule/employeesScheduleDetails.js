'use strict';
App.controller('EmployeesScheduleDetailsCtrl', ['$scope','$state','$stateParams','employeeScheduleDataFactory',function ($scope,$state,$stateParams,employeeScheduleDataFactory){
