'use strict';
App.controller('EmployeesScheduleListCtrl', ['$http','$scope','$state','employeeScheduleDataFactory',function($http,$scope,$state,employeeScheduleDataFactory){
  	
  	$scope.$on('$stateChangeSuccess',function(){
      if($state.is('app.employeesSchedule.list'))
    ...
    $scope.viewDetails=function(id){
      ...
      $state.go('app.employeesSchedule.details',{id:id});
    };
